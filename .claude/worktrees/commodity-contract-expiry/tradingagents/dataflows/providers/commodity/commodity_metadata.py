...
# 品种字典 — 上海期货交易所 (SHFE)
# =============================================================================
# 字段:variety_code(交易所用代码,大写)
#       symbol(新浪/通用代码,大写)
#       name_cn(中文名)
#       name_akshare(AKShare 接口命名,也可能就是中文)
#       category(品类: precious / metal / energy / chemical)
#       unit(计量单位: 吨 / 克 / 千克 / 桶 / 张)
#       contract_size(1 手 = ? 单位)
#       tick_size(最小变动价位)
...
_SHFE_VARIETIES = [
    ...
    ("AL", "AL", "铝", "shfe", "metal", "吨", 5, 5, "1999-08-04"),
    ("ZN", "ZN", "锌", "shfe", "metal", "吨", 5, 5, "2007-03-26"),
    ("PB", "PB", "铅", "shfe", "metal", "吨", 5, 5, "2011-03-24"),
    ("NI", "NI", "镍", "shfe", "metal", "吨", 1, 10, "2015-03-27"),
    ("SN", "SN", "锡", "shfe", "metal", "吨", 1, 10, "2015-03-27"),
    ("AO", "AO", "氧化铝", "shfe", "metal", "吨", 20, 1, "2023-06-19"),
    # 贵金属 — 金银(AKShare SHFE 也涵盖)
    ("AU", "AU", "黄金", "shfe", "precious", "克", 1000, 0.02, "2008-01-09"),
    ("AG", "AG", "白银", "shfe", "precious", "千克", 15, 1, "2012-05-10"),
    # 黑色 — 螺纹/线材/热卷/不锈钢
    ("RB", "RB", "螺纹钢", "shfe", "metal", "吨", 10, 1, "2009-03-27"),
    ("WR", "WR", "线材", "shfe", "metal", "吨", 10, 1, "2009-03-27"),
    ("HC", "HC", "热轧卷板", "shfe", "metal", "吨", 10, 1, "2014-03-21"),
    ("SS", "SS", "不锈钢", "shfe", "metal", "吨", 5, 5, "2019-09-25"),
    # 能化 — 沥青/橡胶/纸浆/燃料油/合成橡胶
    ("BU", "BU", "石油沥青", "shfe", "energy", "吨", 10, 1, "2013-10-09"),
    ("RU", "RU", "天然橡胶", "shfe", "chemical", "吨", 10, 5, "1999-05-04"),
    ("BR", "BR", "合成橡胶", "shfe", "chemical", "吨", 5, 5, "2023-07-28"),
    ("SP", "SP", "纸浆", "shfe", "chemical", "吨", 10, 2, "2018-11-27"),
    ("FU", "FU", "燃料油", "shfe", "energy", "吨", 10, 1, "2004-08-25"),
]

_INE_VARIETIES = [
    # 国际能源 — 原油/20号胶/低硫燃料油/集运指数/国际铜
    ("SC", "SC", "原油", "ine", "energy", "桶", 1000, 0.1, "2018-03-26"),
    ("NR", "NR", "20号胶", "ine", "chemical", "吨", 10, 5, "2019-08-12"),
    ("LU", "LU", "低硫燃料油", "ine", "energy", "吨", 10, 1, "2020-06-22"),
    ("EC", "EC", "集运指数(欧线)", "ine", "energy", "点", 50, 0.1, "2023-08-18"),
    ("BC", "BC", "国际铜", "ine", "metal", "吨", 5, 10, "2020-11-19"),
]

_DCE_VARIETIES = [
    # 农产品 — 豆一/豆二/玉米/玉米淀粉/豆粕/豆油
    ("A", "A", "黄大豆1号", "dce", "agricultural", "吨", 10, 1, "1999-01-18"),
    ("B", "B", "黄大豆2号", "dce", "agricultural", "吨", 10, 1, "2004-12-22"),
    ("C", "C", "黄玉米", "dce", "agricultural", "吨", 10, 1, "2004-09-22"),
    ("CS", "CS", "玉米淀粉", "dce", "agricultural", "吨", 10, 1, "2014-12-19"),
    ("M", "M", "豆粕", "dce", "agricultural", "吨", 10, 1, "2000-07-17"),
    ("Y", "Y", "豆油", "dce", "agricultural", "吨", 10, 2, "2006-01-09"),
    ("P", "P", "棕榈油", "dce", "agricultural", "吨", 10, 2, "2007-10-29"),
    # 黑色 — 铁矿石/焦炭/焦煤/硅铁/锰硅
    ("I", "I", "铁矿石", "dce", "metal", "吨", 100, 0.5, "2013-10-18"),
    ("J", "J", "焦炭", "dce", "metal", "吨", 100, 0.5, "2011-04-15"),
    ("JM", "JM", "焦煤", "dce", "metal", "吨", 60, 0.5, "2013-03-22"),
    # 化工 — 塑料/PVC/聚丙烯/乙二醇/苯乙烯/LPG
    ("L", "L", "聚乙烯", "dce", "chemical", "吨", 5, 1, "2007-07-31"),
    ("V", "V", "聚氯乙烯(PVC)", "dce", "chemical", "吨", 5, 1, "2009-05-25"),
    ("PP", "PP", "聚丙烯", "dce", "chemical", "吨", 5, 1, "2014-02-28"),
    ("EG", "EG", "乙二醇", "dce", "chemical", "吨", 10, 1, "2018-12-10"),
    ("EB", "EB", "苯乙烯", "dce", "chemical", "吨", 5, 1, "2019-09-26"),
    ("PG", "PG", "液化石油气", "dce", "energy", "吨", 20, 1, "2020-03-30"),
    # 农副 — 鸡蛋/粳米/纤维板/胶合板/生猪/原木
    ("JD", "JD", "鸡蛋", "dce", "agricultural", "吨", 10, 1, "2013-11-08"),
    ("RR", "RR", "粳米", "dce", "agricultural", "吨", 10, 1, "2019-08-16"),
    ("FB", "FB", "纤维板", "dce", "agricultural", "立方米", 10, 0.5, "2013-12-06"),
    ("BB", "BB", "胶合板", "dce", "agricultural", "张", 500, 0.05, "2013-12-06"),
    ("LH", "LH", "生猪", "dce", "agricultural", "吨", 16, 5, "2021-01-08"),
    ("LG", "LG", "原木", "dce", "agricultural", "立方米", 60, 0.5, "2024-11-18"),
]

_CZCE_VARIETIES = [
    # 农产品 — 棉花/白糖/PTA/苹果/红枣/花生/菜粕/菜油/菜籽
    ("CF", "CF", "一号棉花", "czce", "agricultural", "吨", 5, 5, "2004-06-01"),
    ("SR", "SR", "白砂糖", "czce", "agricultural", "吨", 10, 1, "2006-01-06"),
    ("CY", "CY", "棉纱", "czce", "agricultural", "吨", 5, 5, "2017-08-18"),
    ("AP", "AP", "苹果", "czce", "agricultural", "吨", 10, 1, "2017-12-22"),
    ("CJ", "CJ", "红枣", "czce", "agricultural", "吨", 5, 5, "2019-04-30"),
    ("PK", "PK", "花生", "czce", "agricultural", "吨", 5, 2, "2021-02-01"),
    ("RM", "RM", "菜粕", "czce", "agricultural", "吨", 10, 1, "2012-12-28"),
    ("OI", "OI", "菜籽油", "czce", "agricultural", "吨", 10, 1, "2013-05-16"),
    ("RS", "RS", "菜籽", "czce", "agricultural", "吨", 10, 1, "2012-12-28"),
    # 粮食 — 普麦/强麦/早籼/晚籼/粳稻
    ("PM", "PM", "普通小麦", "czce", "agricultural", "吨", 50, 1, "2012-01-17"),
    ("WH", "WH", "强麦", "czce", "agricultural", "吨", 20, 1, "2013-05-24"),
    ("RI", "RI", "早籼稻", "czce", "agricultural", "吨", 20, 1, "2013-05-24"),
    ("LR", "LR", "晚籼稻", "czce", "agricultural", "吨", 20, 1, "2014-07-08"),
    ("JR", "JR", "粳稻", "czce", "agricultural", "吨", 20, 1, "2013-11-18"),
    # 能化 — PTA/甲醇/玻璃/纯碱/烧碱/尿素/短纤/对二甲苯/瓶片/动力煤/硅铁/锰硅
    ("TA", "TA", "精对苯二甲酸(PTA)", "czce", "chemical", "吨", 5, 2, "2006-12-18"),
    ("MA", "MA", "甲醇", "czce", "chemical", "吨", 10, 1, "2015-05-18"),
    ("FG", "FG", "玻璃", "czce", "chemical", "吨", 20, 1, "2012-12-03"),
    ("SA", "SA", "纯碱", "czce", "chemical", "吨", 20, 1, "2019-12-06"),
    ("SH", "SH", "烧碱", "czce", "chemical", "吨", 30, 1, "2023-09-15"),
    ("UR", "UR", "尿素", "czce", "chemical", "吨", 20, 1, "2019-08-09"),
    ("PF", "PF", "短纤", "czce", "chemical", "吨", 5, 2, "2020-10-12"),
    ("PX", "PX", "对二甲苯", "czce", "chemical", "吨", 5, 2, "2023-09-15"),
    ("PR", "PR", "瓶片", "czce", "chemical", "吨", 5, 2, "2024-08-30"),
    ("ZC", "ZC", "动力煤", "czce", "energy", "吨", 100, 0.2, "2013-09-26"),
    ("SF", "SF", "硅铁", "czce", "metal", "吨", 5, 2, "2014-08-08"),
    ("SM", "SM", "锰硅", "czce", "metal", "吨", 5, 2, "2014-08-08"),
]

_GFEX_VARIETIES = [
    ("SI", "SI", "工业硅", "gfex", "metal", "吨", 5, 5, "2022-12-22"),
    ("LC", "LC", "碳酸锂", "gfex", "metal", "吨", 1, 50, "2023-07-21"),
    ("PS", "PS", "多晶硅", "gfex", "metal", "吨", 1, 0.5, "2024-12-26"),
]

_CFFEX_VARIETIES = [
    # 股指
    ("IF", "IF", "沪深300股指", "cffex", "financial", "点", 300, 0.2, "2010-04-16"),
    ("IH", "IH", "上证50股指", "cffex", "financial", "点", 300, 0.2, "2015-04-16"),
    ("IC", "IC", "中证500股指", "cffex", "financial", "点", 200, 0.2, "2015-04-16"),
    ("IM", "IM", "中证1000股指", "cffex", "financial", "点", 200, 0.2, "2022-07-22"),
    # 国债
    ("TS", "TS", "2年期国债", "cffex", "financial", "点", 20000, 0.005, "2017-02-27"),
    ("TF", "TF", "5年期国债", "cffex", "financial", "点", 10000, 0.005, "2013-09-06"),
    ("T", "T", "10年期国债", "cffex", "financial", "点", 10000, 0.005, "2015-03-20"),
    ("TL", "TL", "30年期国债", "cffex", "financial", "点", 10000, 0.005, "2023-04-21"),
]
...
for _EX_VARIETIES in (
    ...
    for (variety_code, symbol, name_cn, abbrev, category,
         unit, contract_size, tick_size, list_date) in _EX_VARIETIES:
...
# 合约代码解析正则:
#   - 字母部分(underlying,如 RB / CU / IF)
#   - 可选 4 位数字(YYMM,标准格式)
#   - 可选 3 位数字(YYM,CZCE 历史短格式)
#   - 可选交易所后缀(.SHF / .DCE / .CZC / .INE / .GFEX / .CFFEX 等)
_CONTRACT_CODE_RE = re.compile(
    r"^([A-Z]{1,3})(\d{4}|\d{3})?((?:\.[A-Z]{2,6})?)$"
)


def parse_contract_code(full_symbol: str) -> Optional[Dict[str, str]]:
    """
    解析合约代码 `RB2501.SHF` 为:
        underlying: 品种代码(无年月),如 RB
        year_month: 4 位数字年月(2501)或 3 位(CZCE 历史),无则为 ''
        exchange:  交易所代码(.SHF → SHF),无则为 ''

    无法解析返回 None。
    """
    if not full_symbol:
        return None
    code = full_symbol.strip().upper()
    m = _CONTRACT_CODE_RE.match(code)
    if not m:
        return None
    underlying, yymm, exch_with_dot = m.groups()
    exchange = exch_with_dot.lstrip(".") if exch_with_dot else ""
    return {
...
def resolve_main_continuous(full_symbol: str) -> Tuple[str, str]:
    """
    将合约代码归一化到"主力连续合约代码"(AKShare / 新浪格式)。

    Args:
        full_symbol: 用户传入的合约代码,如 `RB2501.SHF` / `RB0.SHF` / `IF0`

    Returns:
        (main_symbol, original_contract):
            main_symbol           - 喂给 `futures_main_sina` 的主力符号,如 `RB0`
            original_contract     - 用户请求的原合约(剥离交易所后缀),如 `RB2501` / `RB0`

    行为约定:
        - 若 full_symbol 已是连续合约(`RB0` / `IF0`),原样返回。
        - 若 full_symbol 含 YYMM 但 underlying 没有对应主力映射
          (如 IG、TL 等交易所新合约,暂未入库),返回原合约,不做猜测。
    """
    parsed = parse_contract_code(full_symbol)
    if not parsed:
        # 解析失败,透传
        return full_symbol, full_symbol
    underlying = parsed["underlying"]
    if not parsed["year_month"]:
        # 本身已经不含数字年月,视为连续合约 / 主力代码
        return full_symbol, parsed["raw"].split(".")[0] if "." in parsed["raw"] else parsed["raw"]
    main = MAIN_CONTINUOUS_SYMBOLS.get(underlying)
    return (main, parsed["raw"].split(".")[0]) if main else (parsed["raw"], parsed["raw"].split(".")[0])


def is_past_yymm(yymm: str, today: Optional["date"] = None) -> bool:
    """
    判断 YYMM(4 位)是否已过合约月份最后一日(粗略按当月最后一天)。
    注:真实最后交易日因节假日而异,这里只做"已结算"vs"现役合约"的粗判。
         精确判定请调用 get_contract_info()。

    3 位数字(ZYE 历史短格式)无法解析,视为非过期。
    """
    from datetime import date as _date

    if not yymm or len(yymm) != 4 or not yymm.isdigit():
        return False
    try:
        yy = int(yymm[:2])
        mm = int(yymm[2:])
...
if __name__ == "__main__":
    ...
    for v in list_varieties("SHFE"):
        print(f"  {v['symbol']:<4} {v['name_cn']:<10} {v['unit']:<6} {v['contract_size']} {v['list_date']}")
    print()
    print("=== CFFEX 交易时间示例 ===")
