...
[![Version](https://img.shields.io/badge/Version-cn--0.1.11-green.svg)](./VERSION)
[![Documentation](https://img.shields.io/badge/docs-中文文档-green.svg)](./docs/)
[![Original](https://img.shields.io/badge/基于-TauricResearch/TradingAgents-orange.svg)](https://github.com/TauricResearch/TradingAgents)

> 🚀 **最新版本 cn-0.1.11**: 全新LLM提供商集成、模型选择持久化、Web界面大幅优化，支持60+个最新AI模型！
>
> 🎯 **核心功能**: 多LLM提供商支持 | 模型选择持久化 | Docker容器化部署 | 专业报告导出 | 完整A股支持 | 中文本地化
...
**相比原版新增**: 多LLM提供商集成 | 模型选择持久化 | 快速切换按钮 | 320px侧边栏 | 实时进度显示 | 智能会话管理 | 中文界面 | A股数据 | 国产LLM | Docker部署 | 专业报告导出 | 统一日志管理 | Web配置界面 | 成本优化
...
- **v0.1.11** (2025-07-27): 🤖 多LLM提供商集成与模型选择持久化 ✨ **最新版本**
