...
_SHFE_VARIETIES = [
    ...
    # 黑色 — 螺纹/线材/热卷/不锈钢
    ("RB", "RB", "螺纹钢", "shfe", "black", "吨", 10, 1, "2009-03-27", 0.11, 0.0001, 0.05),
    ("WR", "WR", "线材", "shfe", "black", "吨", 10, 1, "2009-03-27", 0.11, 0.0001, 0.05),
    ("HC", "HC", "热轧卷板", "shfe", "black", "吨", 10, 1, "2014-03-21", 0.11, 0.0001, 0.05),
    ("SS", "SS", "不锈钢", "shfe", "black", "吨", 5, 5, "2019-09-25", 0.11, 0.0001, 0.05),
...
_INE_VARIETIES = [
    ...
    ("EC", "EC", "集运指数(欧线)", "ine", "financial", "点", 50, 0.1, "2023-08-18", 0.15, 0.0001, 0.10),
...
_DCE_VARIETIES = [
    ...
    # 黑色 — 铁矿石/焦炭/焦煤
    ("I", "I", "铁矿石", "dce", "black", "吨", 100, 0.5, "2013-10-18", 0.13, 0.0001, 0.06),
    ("J", "J", "焦炭", "dce", "black", "吨", 100, 0.5, "2011-04-15", 0.13, 0.0001, 0.06),
    ("JM", "JM", "焦煤", "dce", "black", "吨", 60, 0.5, "2013-03-22", 0.13, 0.0001, 0.06),
...
_CZCE_VARIETIES = [
    ...
    ("SF", "SF", "硅铁", "czce", "black", "吨", 5, 2, "2014-08-08", 0.09, 0.0001, 0.06),
    ("SM", "SM", "锰硅", "czce", "black", "吨", 5, 2, "2014-08-08", 0.09, 0.0001, 0.06),
]
