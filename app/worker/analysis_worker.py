...
class AnalysisWorker:
    ...
    def __init__(self, worker_id: Optional[str] = None):
        ...
        # 配置参数
        self.heartbeat_interval = getattr(settings, 'WORKER_HEARTBEAT_INTERVAL', 30)
        self.max_retries = getattr(settings, 'QUEUE_MAX_RETRIES', 3)
        self.poll_interval = 1  # 队列轮询间隔（秒）
