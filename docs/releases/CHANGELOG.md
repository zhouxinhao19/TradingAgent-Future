...
本文档记录了TradingAgent-Future项目的所有重要更改。
...
- **A股示例**: 增加A股品种代码示例 (000001平安银行, 600519贵州茅台, 000858五粮液)
- **操作提示**: 明确提示用户输入品种代码后需按回车键确认
