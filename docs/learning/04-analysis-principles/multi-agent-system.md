...
TradingAgent-Future采用多智能体协作机制进行股票分析。什么是多智能体系统？为什么要使用多个AI而不是一个？本文将深入解析多智能体系统的原理和优势。
...
2. **TradingAgent-Future**包含5个核心智能体角色
3. **协作流程**：收集→分析→评估→决策
