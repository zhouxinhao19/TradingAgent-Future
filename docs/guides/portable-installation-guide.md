...
**功能说明**：从数据源同步期货品种基础信息、历史行情、实时行情等数据。
...
**功能说明**：查询期货品种信息，查看 K 线图、技术指标、财务数据等。
...
**功能说明**：使用 AI 多智能体系统对期货品种进行深度分析。

**操作步骤**：
1. 在期货品种详情页点击 "AI 分析" 按钮
2. 选择分析类型：
   - **快速分析**：基于技术指标的快速判断
   - **深度分析**：多维度综合分析
...
**操作步骤**：
1. 在期货品种详情页点击 "加入自选" 按钮
2. 在首页点击 "自选品种" 标签查看自选品种列表
3. 点击 "移除" 按钮可以从自选品种中移除
