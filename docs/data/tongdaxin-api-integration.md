...
Tushare数据接口为TradingAgent-Future提供了高质量的中国期货数据，包括A股、深股、创业板、科创板等所有板块的实时行情和历史数据。
...
Tushare数据接口的集成为TradingAgent-Future带来了以下价值：
...
现在您可以在TradingAgent-Future中无缝分析中国期货品种，享受专业级的本土化期货分析体验！
