# TradingAgent-Future 用户调查问卷 (2025)

## 📋 问卷说明

感谢您使用 TradingAgent-Future！为了更好地了解用户需求，优化产品功能，我们诚邀您参与本次调查。
...
### 6. 您是如何了解到 TradingAgent-Future 的？（单选）
...
### 7. 您使用 TradingAgent-Future 多久了？（单选）
...
### 8. 您使用 TradingAgent-Future 的频率？（单选）
...
### 10. 您使用 TradingAgent-Future 的主要目的是？（多选，最多选 3 项）
...
### 11. 您最看重 TradingAgent-Future 的哪些特点？（多选，最多选 3 项）
...
### 20. 您对 TradingAgent-Future 最满意的地方是什么？（开放题）
...
### 21. 您对 TradingAgent-Future 最不满意的地方是什么？（开放题）
